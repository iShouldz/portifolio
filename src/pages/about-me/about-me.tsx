...
import { Award, MoveDown, Check, Copy } from "lucide-react"
...
const AboutContact = () => {
  ...
  const handleCopyEmail = async () => {
    const email = "pedrosport10@gmail.com"

    try {
      await navigator.clipboard.writeText(email)
      setIsEmailCopied(true)
      toast("E-mail copiado", {
        description: "Agora é só colar no seu app de e-mail ou mensagem.",
      })
      ...
      toast("Não foi possível copiar o e-mail", {
        description: "Tente selecionar o endereço manualmente.",
      })
    }
  }
  ...
  return (
    ...
    >
      ...
      <div className="mb-[30%] grid grid-cols-1 gap-3 lg:grid-cols-12 lg:grid-rows-2">
        ...
        >
          <div className="flex h-full flex-col gap-3" onClick={scrollToDiv}>
            <div className="group flex flex-1 flex-col items-center justify-center gap-3 rounded-[2rem] border border-white/10 bg-white/5 transition-all hover:border-emerald-500/30 hover:bg-white/10">
      ...
      >
        <div className="mx-auto flex flex-col gap-6 rounded-[2.5rem] border border-white/10 bg-background/30 p-8 shadow-2xl backdrop-blur-xl md:p-12">
          ...
          <Separator className="mx-auto w-[30%] max-w-2xl" />

          <div className="mb-8 space-y-2 text-center" ref={contactRef}>
            <h3 className="flex items-center justify-center gap-3 text-2xl font-bold text-foreground md:text-3xl">
              {t("about.social-contact.title")}
            </h3>
            <p className="text-muted-foreground">
              {t("about.social-contact.description")}
            </p>
          </div>
          ...
          <div className="grid gap-3 md:grid-cols-3">
            ...
            >
              <a
                href="https://www.linkedin.com/in/pedro-souza-385794241/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label={t("about.social-contact.linkedin")}
              >
                <LinkedinIcon />
                <span>{t("about.social-contact.linkedin")}</span>
              </a>
            </Button>
            ...
            >
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label={t("about.social-contact.github")}
              >
                <GithubIcon />
                <span>{t("about.social-contact.github")}</span>
              </a>
            </Button>
            ...
            >
              <aside className="flex items-center gap-4">
                {t("about.social-contact.email.address")}
                {isEmailCopied ? (
